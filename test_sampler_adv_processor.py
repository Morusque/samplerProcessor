...
class SamplerAdvProcessorTests(unittest.TestCase):
    ...
    def test_create_model_from_audio_file_uses_hardcoded_scratch_defaults(self):
        ...
        self.assertEqual(MODULE.get_value(zone, "SampleEnd", ""), "511")
        self.assertEqual(MODULE.get_value(zone, "SustainLoop/End", ""), "511")
        self.assertEqual(MODULE.get_value(zone, "ReleaseLoop/End", ""), "511")
        self.assertEqual(MODULE.get_value(zone, "SampleRef/DefaultDuration", ""), "512")
